...
import { LinkSearch, LinkTable } from '.';
...
class LinkList extends React.Component<{}, {
	...
	componentWillMount() {
		...
		this.props.dispatch(linkAction.getLinksByUser(localStorage.getItem(storage.session_user))) 
	}
	...
	render(){
		...
		if(this.props.linkReducer.fetched) {
			linkList = this.props.linkReducer.data
		}
							...
							<div className="row">
								<div className="col-12">
									<div className="welcome-text">
										<span className="section-topname"><i className="fas fa-link mr-1"></i>Enlaces</span>
										<div className="divider-line"></div>
											<h2 className="section-title">Lista de Links</h2>
											<p className="section-subtitle">Desde esta sección podrás buscar, ver y editar los enlaces cargados hasta el momento.</p>
										</div>
									</div>
									<div className="col-12">
										<div className="welcome-text">
											<LinkSearch />
											<div className="my-4">
											<LinkTable linkList={ linkList } /></div>
										</div>
									</div>
									<Footer />
								</div>
